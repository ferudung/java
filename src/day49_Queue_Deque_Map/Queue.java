...
class Queue01 {
    public static void main(String[] args) {
       /*
        Fifo :  First in first out --> Elemanlar ilk eklenen ilk silinir eczane yemekhane vs sektorlerde zmana kaydı
        olan elemanlarin tutullmasinda kullanilir.
