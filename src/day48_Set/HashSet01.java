...
/*
 Set : 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mükerrer(duplicate) eleman olmaz.
            ...
            Set     --> HashSet (hurra seti): 1) HashSet, duplication’a(tekrarlı eleman) izin vermez.
              ...
              (önce gelen girer seti)     2) LinkedHashSet, HashSet'den daha yavas calisir.
             ...
             (benim istediğim girer seti) 2) Elemanlari natural Order'a(String ise alfabetik, sayi ise kucukten buyuge) gore dizer.
                                          3) TreeSet, setlerin en yavasidir. Bu yuzden TreeSet kullanirken dikkatli olunmalı...
              önemli******-->             4)TreeSet "null" object'ini eleman olarak kullanilamaz.
         Set Methods :
...
public class HashSet01 {
	...
	public static void main(String[] args) {
		// 
		java.util.HashSet<String> hs1=new java.util.HashSet<>(Arrays.asList("erdem","furkan","samet","hakan"));
		hs1.add("halil");
		System.out.println(hs1);//[furkan, halil, hakan, erdem, samet]
		
		java.util.HashSet<String> hs2=new java.util.HashSet<>(Arrays.asList("basarili","azimli","nasipli"));
		hs1.addAll(hs2);
