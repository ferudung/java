...
public class C02_AcMo {
 ...
 Public : Projenin her tarafından erişilebilir, yani diğer paketlerden bile. 
 (Class, field, properties, metodlarda, constructor)
 default: Yani hiç bir şey yazılmazsa, yani diğer adı friendly : 
 sadece paketin içindekiler erişebilir. (Class, field,properties metodlarda, constructor)
 private: Sadece içinde bulunduğu sınıf tan erişilebilir.(field,properties, metodlarda)
       1) "private" class member'lar sadece icinde bulunduklari class'larda kullanilabilirler.
           ...
           4) public class member'lara herkes her yerden ulasabilir(farkli java projesi disinda).
            ...
            Farkli package'de
            iseniz iki durum var : a)Child class iseniz ulasabilirsiniz.   
            					   b)Child class degil iseniz ulasamazsiniz.
            
            6) Class'larda da access modifier kullanilir. Ama sadece "public" ve "default" 
            kullanilir.
